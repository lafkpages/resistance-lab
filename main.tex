...
For example, using equation~\ref{eq:csa}, the cross-sectional area of the wire with a diameter of \SI{1.00}{\milli\metre} can be calculated as follows:
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}cccl@{}}
    \toprule
    Length \unc{0.5}{\centi\metre} & CSA \punc{2}{\milli\metre\squared} & Average resistance & Uncertainty     \\ \midrule
    \num{40.0}                     & \num{0.79}                         & \num{1.20}         & \unc{0.2}{\ohm} \\
    \num{40.0}                     & \num{0.50}                         & \num{1.66}         & \unc{0.1}{\ohm} \\
    \num{40.0}                     & \num{0.31}                         & \num{1.98}         & \unc{0.4}{\ohm} \\
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}ccc@{}}
    \toprule
    Line of best fit & Equation                 & Slope (\si{\ohm\centi\metre\squared})  \\ \midrule
    Best             & \(y = 0.6675x + 0.2302\) & 0.6675                                 \\
    Minimum          & \(y = 0.3722x + 1.0261\) & 0.3722                                 \\
    Maximum          & \(y = 0.9554x - 0.9165\) & 0.9554                                 \\ \bottomrule
  \end{tabular}
